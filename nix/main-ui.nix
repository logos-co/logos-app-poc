...
pkgs.stdenv.mkDerivation {
  ...
  preConfigure = ''
    ...
    if [ -d "${logosPackageManager}/include" ]; then
      ...
      cp -r "${logosPackageManager}/include"/* ./logos_dapps/main_ui/generated_code/
    ...
    logos-cpp-generator --metadata ${src}/logos_dapps/main_ui/src/metadata.json --general-only --output-dir ./logos_dapps/main_ui/generated_code
